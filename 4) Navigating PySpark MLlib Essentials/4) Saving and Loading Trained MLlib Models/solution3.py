# Add the line of code needed to save the trained logistic regression model as "my_model" in the current directory
...
# TODO: Save and overwrite the model as "my_model" in the current directory
